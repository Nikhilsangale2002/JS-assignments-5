function ageChange(e){
    ...
    let age = e.target.value; console.log(age); let errorsHolder = document.getElementById('errors-holder'); let submitButton = document.querySelector('button[type="submit"]');
